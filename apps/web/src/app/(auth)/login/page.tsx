    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-6 py-12">
      <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-md border border-slate-100 space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold font-serif text-slate-900 mt-2">Selamat Datang Kembali</h2>
          <p className="text-xs text-slate-500">Masuk untuk mengelola undangan pernikahan digital Anda</p>
        </div>
